            ...
            <div>
              ...
              <div class="mt-1 grid grid-cols-1 gap-3">
                <div>
                  <a
                    href="#"
                    class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-100"
                  >
          ...
          <div class="mt-6">
            <form method="POST" class="space-y-6" @submit.prevent="login">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                  <router-link to="recuperar-contrasena" class="font-medium text-blue-600 hover:text-blue-500">
